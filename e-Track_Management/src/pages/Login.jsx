...
export const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // Pass role to your login function if needed by backend
      const user = await login(email, password, role);
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            ...
            <select
              ...
              onChange={(e) => setRole(e.target.value)}
              required
              className="block w-full rounded-md border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-900 dark:text-white focus:ring-2 focus:ring-primary-500 focus:border-primary-500 p-2.5"
            >
              <option value="">Select Role</option>
              <option value="admin">Admin</option>
              <option value="floorincharge">Floor Incharge</option>
